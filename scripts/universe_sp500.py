"""Universe saham: konstituen S&P 500 (per Juni 2026).

Dipakai oleh fetch_stocks / fetch_fundamentals / fetch_edgar. Ticker yang
sudah delisting/berganti nama akan gagal diunduh dan otomatis dilewati.
"""
TICKERS = [
    ...
    "F", "FANG", "FAST", "FCX", "FDS", "FDX", "FE", "FFIV", "FICO", "FITB",
    ...
    "HD", "HIG", "HII", "HLT", "HON", "HOOD", "HPE", "HPQ", "HRL", "HSIC",
    ...
    "MPWR", "MRK", "MRNA", "MS", "MSCI", "MSFT", "MSI", "MTB", "MTD", "MU",
